...
import (
	...
	"github.com/Balun-courses/microservices_like_in_bigtech/lecture_2/docker/restapi/operations/user"
)

//go:generate swagger generate server --target ../../auth --name Example --spec ../api/swagger.json --principal interface{}
